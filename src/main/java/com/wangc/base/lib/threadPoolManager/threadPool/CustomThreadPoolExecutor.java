...
public class CustomThreadPoolExecutor  extends ExecutorConfigurationSupport
    ...
    private TaskMsgListener listener;

    public TaskMsgListener getListener() {
        return listener;
    }

    public void setListener(TaskMsgListener listener) {
    ...
    protected void afterExecute1(Runnable r, Throwable t) {
        TaskMsg msg = ThreadLocalUtil.get();
        msg.setEndTime(System.nanoTime());
        if (listener != null){
            listener.recordTaskMsg(msg);
        }
        ThreadLocalUtil.remove();
    }

    protected void beforeExecute1(Thread t, Runnable r) {
//        ThreadLocal<String> threadLocal = new ThreadLocal();
//        threadLocal.set(t.getName());
        TaskMsg msg = new TaskMsg();
        msg.setStartTime(System.nanoTime());
        ThreadLocalUtil.set(msg);
